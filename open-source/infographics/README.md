...
![Bernet's 5-Factor Model of Parental Alienation](./bernet-5-factor.png)

The diagnostic spine: five factors that distinguish PA from estrangement.

### Eight Behavioural Manifestations of PA (Bernet)

![Eight Behavioural Manifestations of PA (Bernet)](./eight-manifestations.png)
...
![85% of children with behavioural disorders come from fatherless homes](./father-absence-outcomes.png)
...
![Affido super-esclusivo (Italy)](./affido-super-esclusivo.png)

Italian sole-custody-with-stripped-parental-authority remedy.

### Gezagsbeëindiging (Netherlands)

![Gezagsbeëindiging (Netherlands)](./gezagsbeeindiging.png)
...
![The contact-log spreadsheet that wins cases](./contact-log-spreadsheet.png)
