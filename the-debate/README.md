...
Honest reference on the contested status of parental alienation. Required reading before advancing arguments in either direction.

## Pages

- **[Recognition vs Critique](recognition-vs-critique.md)** — the camps, the genuine agreements, the genuine disagreements, the strongest work on each side, and how to read the literatures honestly

## Related

- [Influencers](../influencers/) — profile pages on figures in both camps
- [Glossary](../glossary/) — vocabulary used by both sides
- [Resources](../resources/) — primary-source databases and key books
