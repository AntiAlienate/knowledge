...
It's a family-therapy modality designed specifically for cases where a child has rejected one parent in the context of a high-conflict separation. It is **not**:
- Standard family counselling
- Individual therapy for the child
- Mediation between the parents

It typically involves:
- **The targeted parent and child** in scheduled sessions
- **The alienating parent** in parallel (separate) work
- **A structured protocol** with named milestones
- **Court oversight** with reports back to the judge
...
1. **"How many reunification cases have you worked? What's your published or measurable outcome rate?"**
2. **"What protocol do you use — and where can I read about it?"**
3. **"How do you handle the alienating parent's role during treatment?"**
4. **"What's your relationship with the [court / evaluator / lawyers]?"**
5. **"What happens if treatment fails — what's the next step you'd recommend?"**
