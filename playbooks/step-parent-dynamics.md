...
> **Not legal or clinical advice.** Step-parent dynamics in PA cases vary enormously by family system, child age, and jurisdiction. Read alongside the [first-90-days playbook](first-90-days.md) and the [accused-of-alienation playbook](accused-of-alienation.md).
...
Most jurisdictions treat step-parents as ancillary to the bio-parents:
- Step-parents rarely have standing in custody proceedings unless they have formally adopted the child
- Step-parents can be witnesses but rarely parties
- Courts can restrict step-parent involvement in handovers or specific decisions
- "De facto parenting" status (UK; some US states) can be acquired over years of caregiving but is rare and difficult to establish
- Adoption by a step-parent requires consent of (or termination of) the other bio-parent's rights — a high bar
...
- [First 90 Days](first-90-days.md) — foundational targeted-parent playbook
