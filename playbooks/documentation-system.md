...
1. **Communication logs** — every message between you, the other parent, and the child
2. **Contact records** — every scheduled and attempted contact with the child
3. **Behavioural observations** — patterns you witness, with date, time, context
4. **Third-party records** — school, medical, extracurricular reports
...
```
YYYY-MM-DD_type_brief-description.ext
```
...
1. **Backup** all files to cold storage (external drive in a different physical location)
2. **Index** new entries by theme (alienating behaviours, missed contact, third-party observations)
3. **Identify** the 3–5 strongest patterns of the quarter — these become evidence stacks
4. **Brief** your lawyer with a one-page summary
5. **Update** your "timeline document" — single page, dates and events, the document a judge will see first
