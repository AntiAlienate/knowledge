...
- [ ] **Read one book a week from [the shelf](../resources/key-books.md).** Knowledge is leverage in court.
...
1. **Calling it "PAS" or demanding the court diagnose your ex.** PA is a *pattern* — argue the behaviors, not the label. Judges flinch from jargon.
2. **Trash-talking the other parent to the child.** It feeds the alienation and is exhibit-material against you.
...
You'll have:
- A timestamped paper trail no judge can wave away
- A professional team that knows your case in detail
- A documented pattern of your engagement vs. the other parent's obstruction
- A child who knows — even if they can't say it — that you didn't give up
