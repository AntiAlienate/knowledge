---
title: "Free Legal Research Tools — for Targeted Parents and Practitioners"
slug: tools-legal-research
last_verified: "2026-05-24"
contributing_publishers:
  - name: "James Christianson"
    site: "https://flow.page/fathersrights"
  - name: "Prosei AI"
    site: "https://prosei.ai"
license: "CC BY 4.0"
---

# Free Legal Research Tools — Every Targeted Parent Should Bookmark
...
- **Best for:** Looking up specific state-statute citations (already used extensively across the [/jurisdictions/](../jurisdictions/README.md) index).
...
Each country / jurisdiction's official statute portal is the canonical source. See [/jurisdictions/](../jurisdictions/README.md) for the per-jurisdiction list (we link directly to official portals where possible: legislature.gov, e-legislation.de, [legislation.gov.uk](https://www.legislation.gov.uk/), etc.).
...
1. **Start with your jurisdiction's primary statute** — find it in [/jurisdictions/](../jurisdictions/README.md).
...
4. **Pair with the Bernet framework** — see [/research/](../research/README.md) and [/open-source/infographics/bernet-5-factor.png](../open-source/infographics/bernet-5-factor.png).

## Verified upstream publishers

This index draws on the curation of two independent publishers in the field:

- **James Christianson** ([flow.page/fathersrights](https://flow.page/fathersrights)) — *How I Got Custody* (Seattle, WA). See [/publishers/james-christianson.md](../publishers/james-christianson.md).
- **Prosei AI** ([prosei.ai](https://prosei.ai)) — self-help legal-software platform whose tool integrates with 12 of the above databases, surfacing the curated set as a working catalogue.
