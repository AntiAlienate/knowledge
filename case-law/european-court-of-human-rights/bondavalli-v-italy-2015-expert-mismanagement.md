...
binding_on: All Member State courts; Italy as respondent
citation_strength: Foundational procedural-fairness ruling
location_tags: [echr, italy, expert-evidence, italian-trilogy]
court: European Court of Human Rights (Chamber)
year: 17 November 2015
case_no: 35532/12
...
PA cases frequently turn on court-appointed evaluator assessments of whether child's contact refusal is induced. Bondavalli requires:
- Methodologically sound assessment (Bernet behavioral criteria)
- Procedurally fair process (both parties heard, challenges addressed)
- Court scrutiny (not rubber-stamping)
