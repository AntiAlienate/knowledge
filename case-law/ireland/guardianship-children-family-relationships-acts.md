---
statute_name: "Ireland — Guardianship of Infants Act 1964 + Children and Family Relationships Act 2015"
court: Irish District Court (family) + Circuit Court + High Court of Ireland
jurisdiction:
  primary: Ireland (national)
  binding_on: All Irish family courts
  origin_country: Ireland
  legal_basis: Guardianship of Infants Act 1964 (as amended); Children and Family Relationships Act 2015; Hague Convention 1980 ratified 1991; Brussels IIb (until Brexit-era reset)
citation_strength: foundational — primary Irish statutory framework for guardianship + access + welfare-paramountcy
last_reviewed: 2026-05-17
location_tags: [ireland, eu, europe, guardianship-infants-act, children-family-relationships-act, welfare-paramountcy, hague-signatory]
---
...
(a) Direct compensatory access time
(b) Order the breaching parent to attend a parenting course
(c) Order security for performance
(d) Order reimbursement of expenses caused by the breach
(e) Vary the order
(f) Order other measures the court considers appropriate
...
1. **Welfare-paramountcy (s.3)** — overrides any parental-rights claim that conflicts
2. **Section 11B enforcement** — graduated tools for documented obstruction
3. **Voice of child (s.32)** — but with court discretion to investigate source of views
4. **Modern terminology** — moves away from "custody battle" framing toward relationship-preservation
...
This combination makes Ireland an unusually strong jurisdiction for cross-border PA cases involving:
- UK-Ireland (Brexit-complicated but bilateral cooperation strong)
- Ireland-EU (full Brussels IIb + ECHR stack)
- Ireland-US (Hague + ECHR + State Department channels)
