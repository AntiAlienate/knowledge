---
statute_name: "Children Act 1989 sections 11J & 11O — Enforcement orders + financial compensation for breach of child arrangements orders (United Kingdom — England and Wales)"
...
jurisdiction:
  ...
  legal_basis: Children Act 1989 c.41, sections 11J and 11O (sections 11A-11P enforcement framework added by Children and Adoption Act 2006; terminology updated by Children and Families Act 2014 for "child arrangements orders")
citation_strength: foundational — the operative statutory enforcement framework for CAO breach in England and Wales; the canonical PA-context contact-enforcement statutes
last_reviewed: 2026-06-13
location_tags: [united-kingdom, england, wales, children-act-1989, section-11J, section-11O, enforcement-order, unpaid-work-requirement, financial-compensation, reasonable-excuse, contact-enforcement]
source_url: https://www.legislation.gov.uk/ukpga/1989/41/section/11J
...
**Source:** legislation.gov.uk — Crown copyright, Open Government Licence v3.0. · **Fetched:** 2026-06-13 · **Editorial commentary licence:** [CC BY 4.0](../../LICENSE)
...
- **Beyond reasonable doubt standard (s.11J(2))** is the criminal standard. Parliament chose this elevated standard deliberately because an unpaid-work requirement is a quasi-criminal sanction. This means PA-pattern contact-obstruction must be **proved to the criminal standard** — practitioners must gather and present rigorous evidence (handover logs, contemporaneous notes, witness statements, communication records).
...
- **Suspended enforcement orders (s.11J(9))** — operationally important: the court may suspend an enforcement order conditional on future compliance, which functions as a deferred sanction.

- **No restriction on multiple orders (s.11J(10))** — the court may impose multiple sanctions for cumulative breaches.

### Section 11O — Financial compensation

- **Lower civil standard for breach (s.11O(2)** — "if the court is satisfied" implies civil standard on the breach itself). This is the operational route where the criminal standard of s.11J cannot be met but the breach is established on balance.

- **Loss-causation requirement (s.11O(2)(b))** — financial compensation requires demonstrable financial loss flowing from the breach. Typical heads include: wasted travel expenses (cancelled visits to which the parent travelled); legal costs of subsequent enforcement applications; lost wages from cancellation of work to attend contact; childcare costs incurred because contact did not occur.

- **Cap at actual loss (s.11O(9))** — no punitive component; pure compensation.

- **Welfare consideration (s.11O(14))** — the court must take into account the welfare of the child concerned. In practice this constrains the s.11O remedy where a heavy financial order on the obstructing parent would itself harm the child (e.g., where the obstructing parent is the primary carer and financial impairment would impact the child's living conditions).
...
- **Companion CA 1989 statutes:** [s.1](/case-law/united-kingdom/children-act-1989-section-1/) (welfare paramountcy) · [s.8](/case-law/united-kingdom/children-act-1989-section-8/) (orders toolkit — defines CAOs) · [s.11](/case-law/united-kingdom/children-act-1989-section-11/) (general principles + conditional orders)
...
- **ECHR positive-obligations anchor:** [ECHR Article 8](/case-law/echr/echr-article-8-right-to-respect-for-private-and-family-life/) — effective enforcement is a positive-obligation requirement
- **Procedural companion:** Family Procedure Rules 2010 Part 18 (procedure on enforcement applications)
- **Jurisdiction page:** [England and Wales](/jurisdictions/england-and-wales/)
