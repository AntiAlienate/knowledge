---
title: "Children and Families Act 2014, Section 14 — 26-Week Time Limit for Care, Supervision and Family Proceedings"
jurisdiction: united-kingdom
type: statute
citation: "Children and Families Act 2014, c. 6, s. 14"
date_in_force: "2014-04-22"
last_amended: "current"
status: in-force
authoritative_url: https://www.legislation.gov.uk/ukpga/2014/6/section/14
tags:
  - twenty-six-week-rule
  - public-law-outline
  - extension-eight-weeks
  - section-32-amendment
  - interim-care-order
pa_relevance: high
---

# Children and Families Act 2014, Section 14 — 26-Week Time Limit for Care, Supervision and Family Proceedings

**Jurisdiction:** England & Wales · **Citation:** Children and Families Act 2014 (c. 6), section 14 · **Authoritative source:** [legislation.gov.uk — s.14](https://www.legislation.gov.uk/ukpga/2014/6/section/14)

The statutory 26-week deadline for public-law children proceedings (care and supervision orders). Operates by amending Children Act 1989 s.32 to require disposal of applications within 26 weeks of issue, with extensions limited to 8 weeks at a time and only when "necessary to enable the court to resolve the proceedings justly". Highly PA-relevant because (a) it accelerates resolution where alienation patterns are forming, and (b) it constrains the procedural delays that alienating-parent tactics typically exploit.
...
- **The 26-week rule constrains alienation-by-delay.** Before s.14, public-law care proceedings routinely lasted 12-18 months; alienation patterns frequently consolidated during that delay. The 26-week deadline forces resolution before alienation becomes entrenched.
- **However, s.14 only applies to PUBLIC-LAW proceedings** (care and supervision orders, s.31 of CA 1989). **Private-law PA disputes** (s.8 child arrangements orders) are NOT subject to the 26-week rule — they are governed by the Public Law Outline only by analogy and the 2024 Pathfinder Pilot is the principal attempt to bring private-law cases under similar pace constraints.
- **s.14(5) extension test** — "necessary to enable the court to resolve the proceedings justly" — has been judicially interpreted strictly. [Re S (A Child) [2014] EWCC B44 (Fam)](https://www.bailii.org/) (Sir James Munby P): extensions are not the default, even where complexity is alleged.
- **8-week extension cap (s.14(8))** prevents the previously-common pattern of indefinite extensions that allowed alienation dynamics to harden.
- **Interim-care-order duration uncap (s.14(4))** — the old 8-week / 4-week cycle was replaced with judicial discretion calibrated to the 26-week framework.

## Related entries

- [Children Act 1989, s.1 — Welfare and No-Order Principles](children-act-1989-section-1.md)
...
- [Children and Families Act 2014, s.10 — MIAM](children-and-families-act-2014-section-10-miam.md)
