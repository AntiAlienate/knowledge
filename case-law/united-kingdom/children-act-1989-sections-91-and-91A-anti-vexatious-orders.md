---
statute_name: "Children Act 1989 sections 91 + 91A — Effect/duration of orders + section 91(14) anti-vexatious-application restrictions (United Kingdom — England and Wales)"
court: Family Court (England and Wales) + Court of Appeal (Civil Division) + UK Supreme Court
jurisdiction:
  primary: England and Wales
  binding_on: All family courts in England and Wales
  origin_country: United Kingdom
  legal_basis: Children Act 1989 c.41, sections 91 + 91A. Section 91 in original 1989 enactment. **Section 91A inserted by Domestic Abuse Act 2021 s.67(1)**, in force 19 May 2022 — codifies and strengthens the anti-vexatious-application regime around section 91(14) orders, with explicit "risk of harm" trigger.
citation_strength: foundational — s.91(14) "barring orders" are the operative tool against repeated/oppressive applications; the s.91A 2022 codification (inserted by DAA 2021) made them substantially more available in domestic-abuse and PA-context cases
last_reviewed: 2026-06-14
location_tags: [united-kingdom, england, wales, children-act-1989, section-91, section-91A, section-91-14, barring-order, anti-vexatious-application, domestic-abuse-act-2021, risk-of-harm, post-order-application-restriction]
source_url: https://www.legislation.gov.uk/ukpga/1989/41/section/91A
...
**Source:** legislation.gov.uk — Crown copyright, Open Government Licence v3.0. · **Fetched:** 2026-06-14 · **Editorial commentary licence:** [CC BY 4.0](../../LICENSE)
...
- **Explicit risk-of-harm trigger** — s.91A(2): the court may make a s.91(14) order where it is satisfied that a further application **"would put the child concerned, or another individual ("the relevant individual"), at risk of harm."** "Harm" includes physical and mental harm, and (per s.91A(3)) for adults includes "ill-treatment or the impairment of physical or mental health." This is the canonical statutory hook for protecting the target parent and the child from continued litigation-as-harassment.

- **Court may act of its own motion** — s.91A(5)(b): the court no longer requires an application from a party to make a s.91(14) order. This means the court can act protectively where it identifies a pattern of vexatious or harassing litigation conduct without the target parent or the child's representative having to formally apply.

- **Material-change-of-circumstances test on leave applications** — s.91A(4): where a named person applies for leave to make a further specified application, the court must consider whether there has been a material change of circumstances. This significantly raises the bar for circumventing a s.91(14) order — the named person must demonstrate that material circumstances have changed since the order was made, not merely that they wish to re-litigate the same issues.

### Practice points (PA-context)

- A target parent in a sustained PA case may apply for a s.91(14) order against the alienating parent to prevent repeat applications seeking further restrictions on contact, where each prior application has failed.

- An alienating parent may attempt to use s.91(14) against the target parent — alleging that the target parent's enforcement applications are themselves vexatious. PA-aware practice resists this framing: applications to enforce contact orders against documented obstruction are not vexatious; they are necessary.

- The 2022 reforms (s.91A) substantially expand the court's protective toolkit — the s.91(14) order is now available much more readily where a "risk of harm" can be identified, including the cumulative harm of being subjected to repeat litigation in PA-context cases.
...
- **Companion CA 1989 statutes:** [s.1](/case-law/united-kingdom/children-act-1989-section-1/) (welfare paramountcy) · [s.8](/case-law/united-kingdom/children-act-1989-section-8/) (orders toolkit) · [s.11](/case-law/united-kingdom/children-act-1989-section-11/) (general principles + interim + conditional CAOs) · [ss.11J + 11O](/case-law/united-kingdom/children-act-1989-sections-11J-11O-enforcement-orders/) (enforcement framework) · [s.16](/case-law/united-kingdom/children-act-1989-section-16-family-assistance-orders/) (family assistance orders)
- **Re-arc case-law line:** *Re A* [2019] EWCA Civ 1735 → *Re S* [2020] EWCA Civ 568 → [*Re H-N* [2021] EWCA Civ 448](/case-law/united-kingdom/re-h-n-2021-ewca-civ-448/) → [*Re C* [2023] EWHC 345 (Fam)](/case-law/united-kingdom/re-c-2023-ewhc-345-fam/)
- **Procedural companion:** Family Procedure Rules 2010, Practice Direction 12J (domestic abuse + harm-fact-finding framework)
- **ECHR anchor:** [ECHR Article 8](/case-law/echr/echr-article-8-right-to-respect-for-private-and-family-life/)
- **Jurisdiction page:** [England and Wales](/jurisdictions/england-and-wales/) · [United Kingdom](/jurisdictions/united-kingdom/)
