---
title: "Domestic Abuse Act 2021, Section 2 — Definition of 'Personally Connected'"
jurisdiction: united-kingdom
type: statute
citation: "Domestic Abuse Act 2021, c. 17, s. 2"
date_in_force: "2021-10-01"
last_amended: "current"
status: in-force
authoritative_url: https://www.legislation.gov.uk/ukpga/2021/17/section/2
tags:
...
# Domestic Abuse Act 2021, Section 2 — Definition of "Personally Connected"

**Jurisdiction:** England & Wales · **Citation:** Domestic Abuse Act 2021 (c. 17), section 2 · **Authoritative source:** [legislation.gov.uk — s.2](https://www.legislation.gov.uk/ukpga/2021/17/section/2)

The statutory definition of the *personally connected* relationship that triggers the [s.1 DAA 2021 domestic-abuse definition](domestic-abuse-act-2021-section-1-definition.md). Critically important in parental-alienation cases because **s.2(1)(f) explicitly extends the DA framework to two people who have a parental relationship in relation to the same child** — even where the parents were never married, never cohabited, and have no other personal connection. This is the statutory hook that catches the *post-separation, never-cohabited co-parents* category that historically fell outside DV-specific legislation.
...
- **s.2(2)(b) — "parental responsibility"** — incorporates by reference the CA 1989 framework. A step-parent who has acquired parental responsibility via [CA 1989 s.4A](https://www.legislation.gov.uk/ukpga/1989/41/section/4A), or a special guardian under s.14A, can be "personally connected" to the other parent for DAA 2021 purposes.
