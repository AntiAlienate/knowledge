...
binding_on: All Czech courts (national civil code)
citation_strength: Foundational statute (NOZ — Novy obcansky zakonik / Act 89/2012)
location_tags: [czech-republic, ceska-republika, prague, praha, brno, ostrava, plzen]
court: Nejvyssi soud + Ustavni soud (Supreme Court + Constitutional Court)
year: 2012 (NOZ enacted, effective 2014); replaces 1964 Family Act
echr_anchor: Article 8 ECHR
hague_1980: Signatory
brussels_iib: EU member
related_cases: [I.US 3216/13, II.US 2155/16, Petrov and Others v Czech Republic (HUDOC)]
---

# Cesko Novy obcansky zakonik (NOZ 2012) — Rodinne pravo
...
The court considers:
- The child's individual personality and capabilities
- The parents' lifestyle
- **The emotional bond between the child and each parent**
- The child's expressed wishes (age-appropriate weight)
- **Each parent's ability to ensure the child's relationship with the other parent**
...
Czech Republic party to ECHR since 1993. Multiple Strasbourg condemnations have shaped doctrine:
- **Reslova v Czech Republic (2006)**: violation for failure to enforce contact orders
- **Andelova v Czech Republic (2015)**: Art. 8 violation for prolonged contact suspension without periodic review
...
- [HUDOC search: Petrov and Others](https://hudoc.echr.coe.int/eng#{%22fulltext%22:[%22Petrov and Others%22]})
- [HUDOC search: Reslova](https://hudoc.echr.coe.int/eng#{%22fulltext%22:[%22Reslova%22]})
- [HUDOC search: Andelova](https://hudoc.echr.coe.int/eng#{%22fulltext%22:[%22Andelova%22]})
