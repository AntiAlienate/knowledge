---
title: "Enforcement of contact orders — sanctions and compulsion comparative"
jurisdiction: comparative
type: comparative-doctrinal
citation: "Comparative entry — enforcement mechanisms for contact orders breached by alienating parent"
date_in_force: "current"
status: in-force
authoritative_url: https://knowledge.antialienate.com/case-law/comparative/contact-order-enforcement-comparative/
tags:
  - enforcement
  - astreintes
  - umgangspflegschaft
...
Cross-border enforcement of contact orders is governed by Brussels IIb Arts. 36-49 (intra-EU) and the Hague 1996 Convention (broader). See [cross-border PA entry](cross-border-pa-hague-1980-brussels-iib.md). The principal pathway is recognition + enforcement in the receiving State; enforcement tools then operate under domestic law of the receiving State.
...
- [DV-PA bidirectionality](dv-allegations-pa-bidirectionality-comparative.md)
