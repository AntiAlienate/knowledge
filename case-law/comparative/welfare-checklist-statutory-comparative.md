---
title: "Welfare-checklist statutory comparative — AT, DE, FR, UK, IE"
jurisdiction: comparative
type: comparative
citation: "AT ABGB § 138 · DE BGB § 1697a · FR Code civil art. 373-2-11 · UK Children Act 1989 s. 1(3) · IE Guardianship of Infants Act 1964 Part V"
...
|---|---|---|---|---|
| **Austria** | [ABGB § 138 sentence 1](../austria/abgb-138-kindeswohl-checklist-verbatim.md) — *leitender Gesichtspunkt, bestmöglich zu gewährleisten* | 12 numbered factors (§ 138 (1) Z 1-12) | **Factor 9** — reliable contacts to both parents + secure attachments; **Factor 10** — avoidance of loyalty conflicts and feelings of guilt | Factor 5 — depends on *Verständnis* + *Fähigkeit zur Meinungsbildung* |
| **Germany** | [BGB § 1697a (1)](../germany/bgb-1697a-kindeswohlprinzip-verbatim.md) — *dem Wohl des Kindes am besten entspricht* | No enumerated list in § 1697a; built up through case law + § 1671 (1) S 2 factors | Implicit only — via § 1626 (3) (*Umgang gehört zum Wohl*) + Wohlverhaltensklausel § 1684 (2) | [FamFG § 159](../germany/famfg-159-anhorung-des-kindes-verbatim.md) — post-KJSG 2021 capacity-based |
| **France** | [Code civil art. 371-1](../france/code-civil-371-1-377-autorite-parentale.md) — *intérêt de l'enfant* | [Art. 373-2-11](../france/code-civil-373-2-11-criteres-jaf-verbatim.md) — 6 enumerated factors | **Factor 3** — aptitude to respect the rights of the other; **Factor 6** — psychological pressures or violence | Factor 2 — via art. 388-1 *discernement* standard |
| **United Kingdom** | [Children Act 1989 s. 1(1)](../united-kingdom/children-act-1989-section-1.md) — *child's welfare shall be paramount* | s. 1(3) — 7 enumerated factors | Implicit only — typically engaged via (a) wishes/feelings, (b) effect of change, (e) harm risk | s. 1(3)(a) — wishes considered with reference to age + understanding |
| **Ireland** | [Guardianship of Infants Act 1964 s. 3(1)](../ireland/guardianship-of-infants-act-1964-s3-welfare-paramountcy-verbatim.md) — *welfare … paramount consideration* | s. 31 Part V — extensive enumerated factors (15+ items) | s. 31(2)(c) — willingness to facilitate contact; s. 31(2)(e) — capacity/willingness to cooperate | s. 31(6) — views considered with reference to age + maturity |
...
**Ireland s. 31(2)(c) + (e)** — express *willingness to facilitate contact* factor (c) and *capacity to cooperate* factor (e). The Irish reform under [Children and Family Relationships Act 2015](../ireland/children-and-family-relationships-act-2015-s63-views-of-child-verbatim.md) is the structurally most operationally PA-aware welfare-checklist among the common-law jurisdictions.

### Tier 2 — Implicit PA factors via interpretation

**United Kingdom CA 1989 s. 1(3)** — implicit only. The checklist factors are PA-engageable but not PA-specific:
- (a) wishes/feelings — engaged where the child's expressed view is autonomous vs alienated
- (e) harm or risk of harm — engaged where alienating conduct constitutes emotional harm (s. 31(9) definition)
- (f) capacity of each parent to meet the child's needs — engaged where alienating parent's conduct demonstrates incapacity to facilitate other-parent contact

**Germany BGB § 1697a** — implicit only. The German welfare-paramountcy provision is residual and unenumerated; PA-pattern analysis operates through:
- § 1626 (3) — *Umgang* belongs to *Wohl des Kindes*
- § 1684 (2) — Wohlverhaltensklausel cooperation duty
- § 1666 — Kindeswohlgefährdung threshold
...
| Ireland | Indirect — s. 31(2)(c) | *willingness to facilitate contact* |
...
**Ireland** — the s. 31 reform under the 2015 Act provides the structurally most operationally PA-aware welfare-checklist among the common-law jurisdictions. The express *willingness to facilitate contact* (s. 31(2)(c)) and *capacity to cooperate* (s. 31(2)(e)) factors track the PA-pattern conduct directly.
...
- [Austria — ABGB § 138 (verbatim, 12 factors)](../austria/abgb-138-kindeswohl-checklist-verbatim.md)
- [Germany — BGB § 1697a (verbatim, residual paramountcy)](../germany/bgb-1697a-kindeswohlprinzip-verbatim.md)
- [France — Code civil art. 373-2-11 (verbatim, 6 factors)](../france/code-civil-373-2-11-criteres-jaf-verbatim.md)
- [UK — Children Act 1989 s. 1 (verbatim, 7 factors)](../united-kingdom/children-act-1989-section-1.md)
- [Ireland — Guardianship of Infants Act 1964 s. 3 + Part V (verbatim)](../ireland/guardianship-of-infants-act-1964-s3-welfare-paramountcy-verbatim.md)
...
- [Comparative — expert evidence admissibility](expert-evidence-admissibility-comparative.md)
