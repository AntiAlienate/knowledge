---
title: "Cross-border parental alienation — Hague 1980, Hague 1996, Brussels IIb intersection"
jurisdiction: comparative
type: comparative-doctrinal
citation: "Comparative entry — Hague Convention 1980 + Hague Convention 1996 + Brussels IIb Regulation 2019/1111"
date_in_force: "current"
status: in-force
authoritative_url: https://knowledge.antialienate.com/case-law/comparative/cross-border-pa-hague-1980-brussels-iib/
tags:
  - hague-1980
  - hague-1996
  - brussels-iib
...
The three layers are non-overlapping in PA practice:
- Hague 1980 governs the **wrongful-removal** dimension (return application)
- Hague 1996 / Brussels IIb govern **jurisdiction + recognition** for the underlying custody/contact litigation
- Brussels IIb adds intra-EU enforcement tools (incl. Art. 27 hearing-of-the-child requirements)
...
1. **The wrongful removal/retention occurs** — typically following a separation, sometimes timed around a custody/contact dispute
2. **The targeted parent applies for return** under Hague 1980
3. **The alienating parent raises Art. 13 (b)** — usually citing (a) the child's expressed objection to return, (b) alleged domestic violence by the targeted parent, (c) the child's settled life in the requested State, or some combination
4. **The requested-State court assesses** the Art. 13 (b) defense and the Art. 13 second-paragraph "child objects" defense
...
- **Art. 27** — mandatory hearing of the child in parental-responsibility proceedings (subject to age + maturity assessment); this provision is the procedural anchor for the [child's-voice framework](childs-voice-age-thresholds-comparative.md)
...
1. **Act quickly under Hague 1980.** Article 12 (1) provides for return if proceedings are commenced within one year of the wrongful removal. After one year, the Art. 12 (2) "settled environment" defense becomes available to the alienating parent.
2. **Central Authority engagement.** Each Contracting State has a Central Authority (Art. 6); applications go through the Central Authority of the requested State.
3. **Anticipate the Art. 13 (b) defense.** Where the alienating parent is likely to allege DV, prepare evidence in the State of habitual residence — police reports, witness statements, medical records — before they become unavailable due to distance.
4. **Engage parallel proceedings carefully.** Litigation in the wrongful-removal State on the underlying custody question can risk legitimising the alienating parent's relocation. The standard practice is to focus on the return application first.
...
- [Cooperation-duty statutory map — Nordic + DACH](cooperation-duty-statutory-map-nordic-dach.md) — domestic-law affirmative-duty layer
- [Graduated-remedy ladder — IT/DE/AT/UK](graduated-remedy-ladder-it-de-at-uk.md) — domestic-law enforcement layer
- [Child's voice age thresholds](childs-voice-age-thresholds-comparative.md) — procedural-rights layer that interacts with Brussels IIb Art. 27
- [ECHR Article 8 — Right to respect for private and family life](../echr/echr-article-8-right-to-respect-for-private-and-family-life.md) — supranational standard governing all three Hague/Brussels instruments
...
The verbatim Hague 1980 Art. 13 text is reproduced above. Primary citations for litigation purposes should reference the [Hague Conference on Private International Law](https://www.hcch.net/) for treaty text and the [HCCH Guide to Good Practice — Art. 13 (b)](https://www.hcch.net/) for interpretation. Brussels IIb provisions should be cited from EUR-Lex (Regulation (EU) 2019/1111).

## Related entries

- [Brussels IIb Reg 2019/1111](../european-union/brussels-iib-regulation-2019-1111-articles-1-7-9-21-27.md)
...
- [HUDOC search: Maumousseau & Washington](https://hudoc.echr.coe.int/eng#{%22fulltext%22:[%22Maumousseau & Washington%22]})
