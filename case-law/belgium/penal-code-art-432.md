...
jurisdiction:
  primary: Belgium (federal)
  binding_on: All Belgian residents and parties to Belgian custody orders
  applies_to: Wallonia, Brussels-Capital Region, Flanders
  legal_basis: Code pénal belge, Article 432
  penalty: Up to 1 year imprisonment + fine (8–150€ × 8 décimes additionnels)
