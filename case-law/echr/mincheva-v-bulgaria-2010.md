---
case_name: Mincheva v. Bulgaria
court: European Court of Human Rights (Fifth Section)
application_no: 21558/03
date_decided: 2010-09-02
jurisdiction:
  primary: ECHR (Strasbourg)
...
citation_strength: landmark — the "state cannot rely on the consequences of its own inaction" principle
last_reviewed: 2026-05-15
location_tags: [europe, bulgaria, echr, strasbourg, article-8, state-inaction, child-refusal]
---
...
- [case-law/echr/solarino-v-italy-2017.md](./solarino-v-italy-2017.md) — paired refusal-protocol weapon
