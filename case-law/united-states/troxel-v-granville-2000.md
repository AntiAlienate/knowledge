...
date_decided: 2000-06-05
jurisdiction:
  primary: United States (Federal — constitutional)
  binding_on: All US state and federal courts
  origin_country: United States
  legal_basis: 14th Amendment Due Process Clause
citation_strength: landmark — defines the constitutional framework for non-parent (incl. grandparent) visitation petitions
last_reviewed: 2026-05-16
location_tags: [united-states, scotus, federal, 14th-amendment, due-process, grandparent-rights, parental-rights]
---
...
1. Limit who can petition (grandparents only, not "any person")
2. Require a triggering event (parental death, divorce, prior substantial relationship)
3. Give "special weight" to the fit parent's decision
4. Require the petitioner to overcome the parental-decision presumption
5. Center "best interest of the child" but only after the parental-presumption is rebutted
