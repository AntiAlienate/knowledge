---
title: "Parental Alienation — Scholarly & Research Resources"
slug: research-index
last_verified: "2026-05-24"
contributing_publishers:
  - name: "James Christianson"
    site: "https://flow.page/fathersrights"
license: "CC BY 4.0"
---

# Parental Alienation — Scholarly & Research Resources
...
- **Brain development effects of father absence** — [NCBI / PMC5330336](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5330336/). Neurodevelopmental literature on the role of father presence in childhood.
...
- ***A Silent Epidemic: Parental Alienation*** — [Psychiatric Times](https://www.psychiatrictimes.com/view/a-silent-epidemic-parental-alienation). Accessible clinical-press overview.

## Family-court bias research

- **Bias in Family Court — American Bar Association paper** — [PDF mirror](https://cdn.flow.page/images/fb5a6487-3514-437f-908e-b6a7da1d8694-pdf). ABA analysis of structural biases in US family-court practice.
- **Fiebert review — *References examining assaults by women on their male partners*** — [PDF mirror](https://dadsnow.org/studies/DV-Fiebert.pdf). Annotated bibliography of 343 scholarly investigations on bidirectional intimate-partner violence.

## Foundational caselaw (US)

- ***Troxel v. Granville*, 530 US 57 (2000)** — [Justia](https://supreme.justia.com/cases/federal/us/530/57/). SCOTUS affirmation of parents' fundamental Fourteenth-Amendment liberty interest in the care, custody, and control of their children.
...
Several of these references were mirrored from the curated index maintained by **James Christianson** ([flow.page/fathersrights](https://flow.page/fathersrights)). See [/publishers/james-christianson.md](../publishers/james-christianson.md) for full attribution.
