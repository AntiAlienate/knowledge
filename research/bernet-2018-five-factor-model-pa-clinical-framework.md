---
title: "Bernet (2018) — The Five-Factor Model for Parental Alienation Identification"
authors: [Bernet, W., Baker, A.J.L.]
year: 2018
publisher: "CRC Press / Routledge — multiple journal articles"
location_tags: [bernet, baker, five-factor-model, differential-diagnosis, clinical-framework]
...
- Pattern of conduct (not isolated incidents):
  ...
  - And many more ([Baker](https://pubmed.ncbi.nlm.nih.gov/?term=Baker+AJL+parental+alienation) & Darnall 2006 enumeration)
...
**False positive prevention** (don't mislabel estrangement as alienation):
- Factor 3 absent → estrangement, not alienation
- Even with all other factors present, if abuse exists, it's estrangement

**False negative prevention** (don't miss real alienation):
- Factor 1 alone is insufficient (children resist contact for many reasons)
- Factor 2 confirms bond existed
- Factor 4 establishes responsible party
- Factor 5 confirms pattern in child consistent with induced rejection
