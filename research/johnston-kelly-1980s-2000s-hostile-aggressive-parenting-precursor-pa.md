---
title: "Johnston & Kelly — Hostile Aggressive Parenting (HAP) — precursor framework"
authors: [Johnston, J.R., Kelly, J.B.]
publication_period: "1980s-2000s"
publishers: ["Family Court Review", "Journal of Divorce and Remarriage", "American Journal of Orthopsychiatry"]
location_tags: [research, foundational, hostile-aggressive-parenting, precursor, joint-custody-research]
...
1. **Conservative framing**: avoided the contested 'syndrome' framing while preserving the underlying clinical observation
2. **Multifactorial**: recognized that contact refusal can have multiple causes (estrangement, alienation, role reversal, abuse, developmental issues)
3. **Child-focused**: emphasized the child's experience and behavior over labeling the parent
4. **Empirically grounded**: integrated clinical research with welfare evaluation
