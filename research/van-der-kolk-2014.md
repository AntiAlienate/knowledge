---
work_title: "The Body Keeps the Score: Brain, Mind, and Body in the Healing of Trauma"
author: Bessel A. van der Kolk
publisher: Viking
year: 2014
isbn: 978-0670785933
type: foundational developmental-trauma + body-based clinical reference
jurisdiction:
  primary: International (clinical reference)
  applies_globally: yes
  legal_basis: research / developmental-trauma reference
citation_strength: foundational — defining text for somatic + developmental-trauma framework now applied to PA child + targeted-parent harm
last_reviewed: 2026-05-16
location_tags: [united-states, international, van-der-kolk, body-keeps-score, developmental-trauma, somatic, attachment]
---
...
1. **Children in alienation campaigns develop somatic symptoms** — stomach aches, headaches, sleep disturbance — that are real, even when the alienator weaponizes them. Distinguishing the somatic-trauma response from manufactured/exaggerated illness is a forensic question (cross-references [posts/12-medical-child-abuse.md](../posts/12-medical-child-abuse.md))
2. **Targeted-parent harm is also somatic** — chronic stress patterns, autonomic dysregulation, increased risk of physical illness in long-term targeted parents
3. **Standard talk therapy alone often insufficient** — body-based interventions (EMDR, somatic experiencing, yoga, neurofeedback) supplement cognitive work for both children and targeted parents
...
- [research/baker-2007.md](./baker-2007.md) — adult-outcomes data
- [research/boss-1999-ambiguous-loss.md](./boss-1999-ambiguous-loss.md) — targeted-parent grief
