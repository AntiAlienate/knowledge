---
work_title: "Parental Alienation and Suicide in Men + The Impact on Men's Mental Health"
author: Leo Sher
journals: "Psychiatria Danubina (2015) + International Journal of Adolescent Medicine and Health (2017)"
years: "2015, 2017"
type: peer-reviewed clinical psychiatry articles
jurisdiction:
  primary: International (clinical reference)
  applies_globally: yes
  legal_basis: research / suicide-risk + mental-health reference
citation_strength: foundational — established elevated suicide risk in PA-targeted parents + named the clinical population
last_reviewed: 2026-05-17
location_tags: [united-states, international, sher, psychiatria-danubina, suicide-risk, targeted-parent-mental-health, mens-health]
---
...
1. **Targeted-parent suicide risk as a recognized clinical concern** — not anecdote, peer-reviewed
2. **The need for trauma-informed therapy** specifically for this population (vs generic counseling)
3. **The case for ambiguous-loss framing** (Boss 1999) as the right clinical model
4. **Court-evidence framing** — when targeted parents present with mental-health crises, the cause is clinically named, not psychogenic
...
1. **Screen for suicide risk** at intake — explicitly, given the 7-fold elevation
2. **Use ambiguous-loss framework** — Pauline Boss; not standard bereavement model
3. **Watch for identity disturbance** — "parent" identity in suspension produces existential distress
4. **Plan for the long arc** — Sher's data suggest risk persists for years; treatment plan must match
5. **Connect to peer support** — Sher's data show social isolation as a key risk multiplier
...
- [research/boss-1999-ambiguous-loss.md](./boss-1999-ambiguous-loss.md) — ambiguous-loss framework
- [research/baker-2007.md](./baker-2007.md) — adult-children outcomes
- [research/harman-kruk-hines-2018.md](./harman-kruk-hines-2018.md) — family-violence reframe
- [research/schore-2001.md](./schore-2001.md) — neuroscience underpinning
- [research/van-der-kolk-2014.md](./van-der-kolk-2014.md) — somatic-trauma framework
