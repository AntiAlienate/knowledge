...
**Stance:** Autor del primer y más citado libro en español sobre Síndrome de Alienación Parental — *S.A.P. Síndrome de Alienación Parental — Hijos manipulados por un cónyuge para odiar al otro* (Almuzara, 1ª ed. 2004, 6ª ed. 2019). Posición de reconocimiento clásico [PASG](https://pasg.info/)-alineado; opera contra el marco que LOPIVI Disp. ad. 17ª codifica. Encuadra el constructo como herramienta clínica/forense para la adjudicación de custodia, en continuidad con la línea pre-LOPIVI representada por STS 519/2017.
