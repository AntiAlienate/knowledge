# Influencer, Advocate & Journalist Outreach — VERIFIED CONTACTS
...
Use alongside [launch-copy.md](launch-copy.md) for the actual outreach copy. Personalise every email — no mass send.

---

## How to use this list

1. **Tier 1 first**, 48 hours before any public launch. Personalised emails only.
...
| 16 | **Wilfrid von Boch-Galhau, MD** *(⚠️ retired)* (Würzburg, Germany) | Practice tel +49 931 3592133 (verify — retired) | Practice address Oberer Dallenbergweg 15, 97082 Würzburg | [drvboch.de](http://www.drvboch.de) | German-language PA monograph; [PASG](https://pasg.info/) voice; Würzburg interdisciplinary group |
...
| 30 | **Väteraufbruch für Kinder e.V.** Germany | info@vafk.de | [vaeteraufbruch.de](https://vaeteraufbruch.de) | Germany's largest shared-parenting NGO; active in [BVerfG](https://www.bundesverfassungsgericht.de/) / ECHR cases |
...
## Sample personalised email template
