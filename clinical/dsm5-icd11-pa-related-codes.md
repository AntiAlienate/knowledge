---
title: "DSM-5 + ICD-11 Diagnostic Codes Relevant to Parental Alienation"
type: clinical-code reference
jurisdiction:
  primary: International (clinical reference)
  applies_globally: yes
  legal_basis: APA DSM-5 (2013, TR 2022) + WHO ICD-11 (in force 2022)
...
### [DSM-5](https://www.appi.org/products/dsm): V995.51 / T74.32XA — Child Psychological Abuse
...
**PA-relevance:** When an alienating parent fabricates, exaggerates, or induces illness in the child to support reduced-contact arguments — see [posts/12-medical-child-abuse.md](../posts/12-medical-child-abuse.md). Significantly more serious than V995.51 — implies deception + falsification.

### [ICD-11](https://icd.who.int/): QE52 — Caregiver-Child Relationship Problem
...
## The [DSM-5](https://www.appi.org/products/dsm)/ICD-11 inclusion campaign

Bernet (2010) led a multi-year campaign to add **"Parental Alienation"** as a standalone diagnostic code. The campaigns:

- **[DSM-5](https://www.appi.org/products/dsm) campaign (2010-2013)** — did not succeed. PA was not added as a standalone diagnosis.
- **[DSM-5-TR](https://www.appi.org/products/dsm) (2022)** — V995.51 + V61.29 retained but no standalone PA code.
- **[ICD-11](https://icd.who.int/) campaign (2015-2018)** — same outcome; standalone PA code rejected.
