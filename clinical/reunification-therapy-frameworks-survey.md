...
type: clinical
year: 2026 survey
citation_strength: Practitioner reference (navigation of named reunification interventions)
location_tags: [global, english-language, clinical-intervention, reunification]
related_research: [Warshak 2010-2020 Family Bridges, Friedlander-Walters 2010 MMFI, Polak-Saini 2015]
---
...
1. **Court-anchored**: judicial reinforcement beats voluntary participation
2. **Both-parents work**: not just the alienated child + rejected parent; the favored parent must also work the program
3. **PA-informed therapist**: generic family therapists without PA training often make cases worse
4. **Aftercare critical**: gains from intensive workshops dissipate without 6-12 month structured aftercare
5. **Realistic goals**: full warm reconciliation may not happen; meaningful reconnection often will
6. **Time-matters**: shorter delay = better outcome (Schore right-brain attachment evidence)
...
Choose a reunification framework based on:
- **Severity** of the alienation (mild → outpatient; severe → intensive)
- **Both parents' willingness** (full unwillingness → court-ordered intensive)
- **Court's appetite** for custody transfer
- **Resources available** (cost is real)
- **Child's developmental stage** (younger = more intervention options; older teens = fewer effective ones)
- **Therapist's specific PA training** (don't skimp on this)
