...
- Primary verification done against the Approved Judgment PDF hosted at judiciary.uk (filename 're-s-a-child-judgment290420.pdf', 31 pages, [2020] EWCA Civ 568, Case No B4/2020/0318). [BAILII](https://www.bailii.org/) (https://www.bailii.org/ew/cases/EWCA/Civ/2020/568.html) returned an Anubis bot-protection challenge wall at retrieval time on 2026-05-31 (UTC) and could not be read directly; the judgment text used for the verbatim_quotes block therefore comes from the judiciary.uk Approved Judgment PDF, which is the same Approved Judgment as the [BAILII](https://www.bailii.org/) version. The source_url on each verbatim quote nevertheless points at [BAILII](https://www.bailii.org/) as the canonical citation venue per AntiAlienate house style.
