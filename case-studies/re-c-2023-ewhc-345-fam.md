...
- **Re Y (Experts and Alienating Behaviour: The Modern Approach) [2026] EWFC 38** (UK-EWS) — [`re-y-2026-ewfc-38`](./re-y-2026-ewfc-38.md) — Sir Andrew McFarlane P sets aside first-instance findings of 'alienating behaviour' built on the report of Ms Melanie Gill, who was not on the [HCPC](https://www.hcpc-uk.org/) Practitioner Psychologist register and not a Chartered Member of the [BPS](https://www.bps.org.uk/). Re Y operationalises the Re C guidance into a set-aside remedy: where the instructing court did not give the 'short judgment' required by Re C [98] on why it was appropriate to instruct an unregulated psychologist, findings dependent on that evidence are vulnerable on appeal.
...
- **[BVerfG](https://www.bundesverfassungsgericht.de/) 17.11.2023 — 1 BvR 1076/23** (DE) — [`bverfg-1-bvr-1076-23-germany-2023`](./bverfg-1-bvr-1076-23-germany-2023.md) — German Federal Constitutional Court constitutional critique of PAS-based Sachverständigengutachten in custody proceedings — civil-law parallel to Re C on different doctrinal grounds (Art. 6 Abs. 2 GG / Kindeswohl constitutional protection rather than [HCPC](https://www.hcpc-uk.org/) registration). Together with Re C and the OLG Frankfurt 7 UF 88/25 companion case, [BVerfG](https://www.bundesverfassungsgericht.de/) 1 BvR 1076/23 describes the European convergence on regulated-expert-only PA evidence.
