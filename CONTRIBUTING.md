...
- **Identify what is empirically established vs. what is contested.** Use clear confidence-level language (e.g., the [evidence base](evidence/pa-as-child-abuse.md) has explicit "high confidence / moderate / low confidence" sections).
...
See the [case studies open gaps](case-studies/README.md#honest-gaps--wanted-contributions) and the [evidence section coming-next list](evidence/README.md#coming-next). Particularly wanted:
