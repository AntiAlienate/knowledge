...
Cross-jurisdictional comparative materials for PA-context family law.

## Pages

- [Global PA jurisdictional index](global-pa-jurisdictional-index.md) — comparative survey of how different jurisdictions handle parental alienation in family-court practice
- [Hague 1980 + Brussels IIb cross-border framework](hague-1980-brussels-iib-cross-border-framework.md) — comparative analysis of the international child-abduction return regime and its EU-specific overlay
