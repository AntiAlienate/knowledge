---
title: "Astreinte Application — Belgian / French / Dutch Civil Procedure"
slug: astreintes-application
type: template
applies_to: ["Belgium (Code judiciaire Art. 1385bis)", "France (CPCE L. 131-1)", "Netherlands (Rv Art. 611a-h)"]
...
Use your [contact log](./contact-log-spreadsheet.md). For an astreinte motion, you want a minimum of 5-10 documented breaches over a 2-3 month window. Each breach should have a date, the verbatim refusal, and a documentary source.
