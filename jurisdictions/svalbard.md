...
- **Norwegian Healthcare Authority** — <https://www.helsenorge.no/>
...
1. **Norwegian Government — Svalbard** — <https://www.regjeringen.no/> (Norwegian Government) [no,en]
2. **Norwegian Supreme Court** — <https://www.hoyesterett.no/> (Norwegian Supreme Court) [no,en]
