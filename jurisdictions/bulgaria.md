...
1. **Върховен касационен съд (Supreme Court of Cassation)** — <https://vks.bg/> (Supreme Court of Cassation) [bg,en]
2. **Конституционен съд** — <https://constcourt.bg/> (Constitutional Court) [bg,en]
3. **Lex.bg — Bulgarian legal database** — <https://lex.bg/> (Lex.bg) [bg]
