...
- **Hội Tâm lý học Việt Nam (Vietnam Psychological Association)** — <http://tamlyhoc.com.vn/>
...
1. **Tòa án nhân dân tối cao** — <https://www.toaan.gov.vn/> (Supreme People's Court of Vietnam) [vi,en]
2. **Thư viện Pháp luật — Legal Library** — <https://thuvienphapluat.vn/> (ThuVienPhapLuat.vn) [vi,en]
3. **Vietnam Psychological Association** — <http://tamlyhoc.com.vn/> (VPA) [vi]
