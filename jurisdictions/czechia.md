...
1. **Nejvyšší soud (Supreme Court)** — <https://www.nsoud.cz/> (Nejvyšší soud) [cs,en]
2. **Ústavní soud (Constitutional Court)** — <https://www.usoud.cz/> (Ústavní soud) [cs,en]
3. **Zákony pro lidi — Czech legal database** — <https://www.zakonyprolidi.cz/> (AION CS) [cs]
