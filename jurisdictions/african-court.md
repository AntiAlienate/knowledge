...
- `jurisdiction:inter-american-court`
- `evidence:cross-border-parental-abduction-and-pa-intersection`
- `evidence:childrens-rights-paramountcy-doctrine`

## Sources

1. **African Court on Human and Peoples' Rights** — <https://www.african-court.org/> (ACtHPR) [en]
2. **African Commission on Human and Peoples' Rights** — <https://www.achpr.org/> (ACHPR) [en]
3. **African Committee on the Rights and Welfare of the Child** — <https://www.acerwc.org/> (ACERWC) [en]
