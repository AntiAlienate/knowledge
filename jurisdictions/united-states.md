...
- **Association of Family and Conciliation Courts ([AFCC](https://www.afccnet.org/))** — International voluntary association of family-court professionals. [AFCC](https://www.afccnet.org/) Model Standards for Child Custody Evaluations (2006, updated 2022) function as the de facto national US practice standard for custody evaluation absent a federal regulator. AFCC Guidelines for Examining Intimate Partner Violence (2016) provide DV-informed practice guidance. AFCC's institutional position on PA is differential-diagnosis-oriented rather than recognition-anchored. — <https://www.afccnet.org/>
...
- **2011** — AACAP Practice Parameter for Child Custody Evaluation (2011) — engages alienation behaviours within differential-diagnosis frame without endorsing PAS-as-syndrome. — <https://www.aacap.org/>
...
- DSM-5-TR CAPRD V995.51 / Z62.898 is foregrounded as the load-bearing US institutional reference; [Bernet et al.](https://pasg.info/) 2016 JAACAP framework paper noted as most-cited US PA-debate reference.
