...
1. **Augstākā tiesa (Supreme Court of Latvia)** — <https://at.gov.lv/> (Augstākā tiesa) [lv,en]
2. **Satversmes tiesa** — <https://www.satv.tiesa.gov.lv/> (Satversmes tiesa) [lv,en]
3. **Likumi.lv — Latvian legal database** — <https://likumi.lv/> (Latvijas Vēstnesis) [lv,en]
