...
1. **Biblioteca del Congreso Nacional de Chile (BCN)** — <https://www.bcn.cl/> (Chilean Government) [es]
2. **Corte Suprema de Chile** — <https://www.pjud.cl/> (Chilean Government) [es]
3. **UNESCO World Heritage Centre — Rapa Nui National Park** — <https://whc.unesco.org/en/list/715/> (UNESCO) [en]
