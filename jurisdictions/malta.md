...
1. **Courts of Malta** — <https://courtservices.gov.mt/> (Government of Malta) [mt,en]
2. **Legislation.mt — Maltese legal database** — <https://legislation.mt/> (Ministry for Justice) [mt,en]
3. **Malta Chamber of Psychologists** — <https://www.maltapsychology.com/> (Malta Chamber of Psychologists) [en]
