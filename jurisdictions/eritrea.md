...
- **Civil Code 1991 (Transitional)** — Civil Code (Transitional) (1991) — <https://www.shabait.com/>
  - Transitional Civil Code drawing on Ethiopian Civil Code 1960 heritage adopted upon de facto independence.
- **Customary Law Code framework** — Customary Law Code framework (1995) — <https://www.shabait.com/>
  - Federal framework codifying customary-law provisions across multiple ethnic communities.
...
- **Ministry of Health, Eritrea** — <https://www.shabait.com/>

## Anonymisation convention

Eritrean family-court decisions are anonymised per Supreme Court practice using initials where available.

## Key developments

- **1991** — Eritrea achieved de facto independence after 30-year war of independence from Ethiopia; Transitional Civil Code adopted drawing on Ethiopian Civil Code 1960 heritage.
- **1993** — Independence referendum confirmed Eritrean sovereignty.
- **1995** — Federal framework codifying customary-law provisions across multiple ethnic communities.
...
1. **Shabait — Eritrean government information** — <https://www.shabait.com/> (Eritrean Government) [ti,ar,en]
2. **Refworld (UNHCR) — Eritrea legal documents** — <https://www.refworld.org/> (UNHCR) [en]

## Editorial notes

- Eritrea jurisdiction sidecar — multi-layer mixed-legal-system Horn of Africa (Italian-civil-law + English common-law procedural + Ethiopian Civil Code 1960 heritage + customary-law via Community Courts + Sharia + non-Hague). Constitution 1997 ratified-unimplemented distinctive.
- PA-recognition: silent statutory + no-apex-position + silent regulator.
- Joins Horn of Africa + multi-layer-colonial-inheritance + Italian-English-dual-colonial + Constitution-ratified-unimplemented-distinctive + non-Hague Convention clusters within the corpus.
