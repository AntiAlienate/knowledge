...
- `jurisdiction:liancourt-rocks`
- `jurisdiction:crimea`
- `jurisdiction:russian-annexed-ukrainian-oblasts-2022`
- `evidence:cross-border-parental-abduction-and-pa-intersection`
- `evidence:childrens-rights-paramountcy-doctrine`

## Sources

1. **Japanese Ministry of Foreign Affairs — Northern Territories** — <https://www.mofa.go.jp/region/europe/russia/territory/> (Japanese Government) [ja]
2. **Russian Government** — <http://www.kremlin.ru/> (Russian Government) [ru]
