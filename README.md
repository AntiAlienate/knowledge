...
| **[/the-debate/](./the-debate/)** | Recognition vs critique — both camps mapped honestly with strongest works | 1 + index |
...
| **[/research/](./research/)** | Scholarly and research resources | Curated |
| **[/influencers/](./influencers/)** | The researchers, clinicians, practitioners shaping the field (recognition + critic + middle) | 19 |
| **[/community/](./community/)** | Reddit subreddits + advocacy orgs (US/UK/AU/DE/FR/ES/AR/Intl) | 3 + many links |
...
PA is a contested field. This repository represents **both** recognition-camp and critique-camp literatures and figures. We do not take a position on the contested questions — those are for clinicians, courts, and policy bodies to resolve. Our job is to make the field navigable. See [/the-debate/](./the-debate/) for our reasoning.
