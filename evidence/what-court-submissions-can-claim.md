# What Court Submissions Can Honestly Claim — A Practitioner Distillation
...
1. [PA as Child Abuse](pa-as-child-abuse.md)
2. [Mental-Health Outcomes](mental-health-outcomes.md)
3. [Reunification Therapy Outcomes](reunification-outcomes.md)
4. [Forensic Operation in Courts](forensic-operation-in-courts.md)
5. [International Institutional Positions](international-institutional-positions.md)
6. [Prevalence Claims Under Scrutiny](prevalence-claims.md)
7. [Diagnostic Codes That DO Apply](diagnostic-codes-that-apply.md)
...
**Cross-references:** [Reunification Therapy Outcomes](reunification-outcomes.md) §1-7

**Anticipated critique on the affirmative side:** [Warshak's](https://warshak.com/family-bridges/) published outcomes, Harman's reconnection statistic. **Counter on the affirmative side:** the methodological standard required for court-ordered intervention should be met by *independent* data; reliance on programme-staff self-report is exactly what Daubert/Frye scrutiny targets. The Kayden's Law standard (34 U.S.C. § 10446(k)(3)(B)(iii)) requires "generally accepted and scientifically valid proof of safety, effectiveness, and therapeutic value."
...
**Primary support:**
- [Saunders](https://www.ovw.usdoj.gov/) (2015) NCJFCJ guidebook — verbatim on PAS misuse and evaluator-training survey statistics
...
The widely-cited [Family Bridges](https://warshak.com/family-bridges/) figure is the *maintained-gains* rate at 90-day follow-up (18/22), not the end-of-workshop rate (22/23 ≈ 96%). Programme-staff judgment is the outcome measure. The validated communication scale used in the [TPFF](https://turningpointsforfamilies.com/) outcome study (Harman 2022) showed no statistically significant change. There are no independent peer-reviewed efficacy studies for any major reunification programme. The Kayden's Law standard (federal 2022) is not met by any extant outcome study on a conservative reading.
...
For jurisdiction-specific guidance, start with the [Case Studies Global Comparison Matrix](../case-studies/global-comparison.md) and the relevant case in your jurisdiction.

---

## Cross-references

- All seven [evidence pages](README.md) referenced individually above
- [Case Studies — Global Comparison Matrix](../case-studies/global-comparison.md)
- [Case Studies — Open Question: US clean reversal gap](../case-studies/open-question-clean-us-appellate-reversal-of-pa-finding.md)
- [Glossary](../glossary/glossary.md)
- [The Debate](../the-debate/recognition-vs-critique.md)
