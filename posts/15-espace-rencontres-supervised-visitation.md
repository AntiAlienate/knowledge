...
**Originally published at [antialienate.com/blog/espace-rencontres-supervised-visitation](https://www.antialienate.com/blog/espace-rencontres-supervised-visitation).**
...
1. **Visites supervisées** — at-center contact with an observer present
2. **Droit de visite encadré (transfert)** — third-party transfer only, no in-visit observation
...
See [posts/61-supervised-visits-belgium.md](./61-supervised-visits-belgium.md) for the full procedure:

1. Motion for **Modality 4** (private *psychologue* / *éducateur*) — 2-4 week availability vs 4-6 month wait
2. Request **interim family-member supervision** while you wait
3. **Invoke ECHR delay doctrine** in writing — *Improta v. Italy* (2017) + *Bondavalli v. Italy* (2015)

## Source-blog hyperlinks

| Live URL | Title |
|---|---|
| [antialienate.com/blog/espace-rencontres-supervised-visitation](https://www.antialienate.com/blog/espace-rencontres-supervised-visitation) | Espace Rencontres — Belgium's Supervised Visitation |
