# When the Psych Report Goes Against You — The Defense Playbook
...
**Originally published at [antialienate.com/blog/psych-report-defense](https://www.antialienate.com/blog/psych-report-defense).**
...
In US federal/most state courts (*Daubert v. Merrell Dow*, 1993) and Canadian courts (*R. v. Mohan*, 1994):
- Is the method generally accepted in the field?
- Is the method reliable + reproducible?
- Has the evaluator disclosed error rates / known limitations?
...
Motion for a court-appointed second evaluator with **specific PA training** — see [posts/25-court-appointed-pa-expert.md](./25-court-appointed-pa-expert.md). Frame the motion as procedural fairness, not as attacking the first evaluator.

### 6. Cross-examination preparation

If the report goes to trial:
- Request all underlying notes, recordings, test protocols, scoring sheets
- Identify factual errors in the report (names, dates, sequence)
- Prepare 3-5 methodology gaps for cross
- Have your lawyer cite *Re C [2023] EWHC 345* + *Bondavalli v. Italy* (ECHR 2015) framing
...
| Live URL | Title |
|---|---|
| [antialienate.com/blog/psych-report-defense](https://www.antialienate.com/blog/psych-report-defense) | When the Psych Report Goes Against You |

## Related entries

- [posts/19-custody-evaluators-prepare.md](./19-custody-evaluators-prepare.md)
- [posts/25-court-appointed-pa-expert.md](./25-court-appointed-pa-expert.md)
- [posts/01-why-never-say-pa-in-court.md](./01-why-never-say-pa-in-court.md)
