...
**Originally published at [antialienate.com/blog/stockholm-syndrome-captive-child](https://www.antialienate.com/blog/stockholm-syndrome-captive-child).**
...
1. **Perceived threat to survival** — child believes the alienator's framing that the targeted parent is dangerous
2. **Small kindnesses from the captor** — the alienator's "love" is intermittent and contingent
3. **Isolation from outside perspectives** — the child is cut off from the targeted parent's worldview, family, and sometimes friends
4. **Perceived inability to escape** — the child cannot leave the home or refuse the alienator's narrative
...
| Live URL | Title |
|---|---|
| [antialienate.com/blog/stockholm-syndrome-captive-child](https://www.antialienate.com/blog/stockholm-syndrome-captive-child) | Stockholm Syndrome and the Captive Child |
