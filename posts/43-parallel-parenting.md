...
**Originally published at [antialienate.com/blog/parallel-parenting](https://www.antialienate.com/blog/parallel-parenting).**
...
Through court-admissible apps (OurFamilyWizard, Talking Parents, AppClose). See [posts/36-co-parenting-apps-court-admissible.md](./36-co-parenting-apps-court-admissible.md). Voice/in-person communication only for genuine emergencies.

### 4. Pre-agreed escalation paths

When disagreement is inevitable, you don't argue in real-time. The path is pre-defined:
- Step 1: written exchange via app, 48-hour response window
- Step 2: parenting coordinator or mediator (court-ordered)
- Step 3: motion to the court
...
| Live URL | Title |
|---|---|
| [antialienate.com/blog/parallel-parenting](https://www.antialienate.com/blog/parallel-parenting) | Parallel Parenting vs Co-Parenting |

## Related entries

- [posts/36-co-parenting-apps-court-admissible.md](./36-co-parenting-apps-court-admissible.md)
- [posts/45-coparenting-with-alienator.md](./45-coparenting-with-alienator.md) *(seed)*
- [posts/31-high-conflict-tactics.md](./31-high-conflict-tactics.md)
