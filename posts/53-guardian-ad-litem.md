...
**Originally published at [antialienate.com/blog/what-is-a-guardian-ad-litem](https://www.antialienate.com/blog/what-is-a-guardian-ad-litem).**
...
1. **Insight** — does this parent see their role in the conflict?
2. **Self-regulation** — does this parent flip when challenged?
3. **Child-focus** — does every answer come back to the child?
4. **Willingness to facilitate the other parent's relationship** — this carries enormous weight
5. **Evidence over emotion**
6. **Whether you use the meeting to litigate or to parent**
...
3. Know the GAL's professional background (LinkedIn, bar profile)
...
| Live URL | Title |
|---|---|
| [antialienate.com/blog/what-is-a-guardian-ad-litem](https://www.antialienate.com/blog/what-is-a-guardian-ad-litem) | What Is a Guardian Ad Litem |

## Related entries

- [posts/19-custody-evaluators-prepare.md](./19-custody-evaluators-prepare.md) *(seed)*
- [posts/51-documenting-pa-comprehensive.md](./51-documenting-pa-comprehensive.md) — evidence framework
- [posts/45-coparenting-with-alienator.md](./45-coparenting-with-alienator.md) — containment protocols
