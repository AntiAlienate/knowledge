...
7. **Borrowed scenarios** — events the child could not have witnessed
8. **Spread of animosity** to the targeted parent's extended family
...
| Live URL | Title |
|---|---|
| [antialienate.com/blog/recognizing-parental-alienation-key-signs](https://www.antialienate.com/blog/recognizing-parental-alienation-key-signs) | Recognizing Parental Alienation — The Key Signs |

## Related entries

- [posts/54-spotting-pa-early-warning-signs.md](./54-spotting-pa-early-warning-signs.md) — paired SEO + 4-tier early-warning system
- [posts/16-estrangement-vs-alienation.md](./16-estrangement-vs-alienation.md) *(seed)*
