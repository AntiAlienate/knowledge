...
1. **Disparagement / denigration** — names, blame, false accusations made to or in front of the child
2. **Gatekeeping / interference with contact** — cancelled visits, blocked calls, withheld school/medical info
3. **Fostering fear / forced allegiance** — telling the child they don't have to visit, framing you as dangerous, rewarding rejection
4. **Erasing your presence** — removing photos, disposing of gifts, name changes, rewriting family history
5. **Enmeshment / role reversal** — child as confidant, mediator, surrogate spouse
...
- **File naming**: `YYYY-MM-DD - [brief description] - [type].ext`
  - Example: `2026-04-15 - Mother cancels visitation - email.pdf`
- **Master chronological log** (spreadsheet)
...
| Live URL | Title |
|---|---|
| [antialienate.com/blog/documenting-parental-alienation-for-court](https://www.antialienate.com/blog/documenting-parental-alienation-for-court) | Documenting Parental Alienation for Court — The Comprehensive Framework |

## Related entries

- [posts/52-documenting-alienation-court-tactical.md](./52-documenting-alienation-court-tactical.md) — tactical daily checklist version
- [posts/20-document-pa-complete-evidence-guide.md](./20-document-pa-complete-evidence-guide.md) *(seed)*
- [posts/19-custody-evaluators-prepare.md](./19-custody-evaluators-prepare.md) *(seed)*
